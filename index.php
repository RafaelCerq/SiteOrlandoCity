...
<html>
	<head>
		<meta charset="utf-8">
		<meta name="viewport" content="width:device-width, initial-scale=1"><!--irá utilizar a largura maxima do device, escala inicial de zoom -->
		...
		<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.1.0/css/all.css" integrity="sha384-lKuwvrZot6UHsBSfcMvOkWwlCMgc0TaWr+30HWe3a4ltaBwTZhyTEggF5tJv8tbt" crossorigin="anonymous"> <!--Fontes icones. Site Fontawesome -->
		<link rel="stylesheet" href="css/orlando.css">
		<link rel="stylesheet" href="css/orlando-mobile.css"><!--css mobile tem que ser depois pois irá sobreescrever alguns itens -->
	</head>
	<body>
		...
		<header>
			...
			<div class="header-black">
				<div class="container">
					...
					<ul class="pull-right">
						<li class="club-01"><a href="#"></a></li><!--utiliza tag A para conseguir clicar, o # irá redirecionar para a mesma pagina -->
			...
			<!--Container é um recurso do bootstrap utilizado para centralizar itens -->
			<div class="container">
				<div class="row">
							...
							<li class="search">
							    <div class="input-group">
							      ...
							      <span class="input-group-btn">
							      	<!--tag I utilizada para coloar icones. fa-search faz parte do fontawesome, assim como os recursos do bootstrap -->
		...
		<section>
				...
				<div class="row thumbnails owl-carousel owl-theme">
					<div class="item">
						<div class="item-inner">
							...
							<h3>Olando City Acquires Goalkepper Joe Bendik From Toronto FC</h3>
			...
			<div id="estatisticas">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-4">
							<p>61348<small>Stadium Capacity</small></p> <!--tag p(paragrafo), ela automaticamente coloca margem interna e externa-->
						</div>
						<div class="col-md-4">
		...
		<footer>
			<div class="row row-cinza-claro">
				<div class="container">
					...
					<div class="row">
						<div class="col-md-2 text-center hidden-xs"><!-- hidden-xs retira as imagens no mobile -->
							<img class="logotipo" src="img/orlando-logo.png" alt="Logotipo">
						</div>
						<div class="col-md-10 row-cols">
							...
							<div class="row">
								<div class="col-md-4 col-popular-post  hidden-xs">
									...
									<ul class="list-unstyled"><!--tag para criar lista de itens. Classe do boostrap para retirar ponto da lista-->
										<li>
								...
								<div class="col-md-4 col-get-in-touch">
									...
									<p class="hidden-xs"><a href="tel:1855ORLCITY"><i class="fa fa-phone"></i>1.885.ORL.CITY</a></p>
